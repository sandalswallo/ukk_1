                     ...
                     <div class="carousel-caption">
                        <div class="row d_flex">
                           ...
                           <div class="col-md-6">
                              <div class="text_img">
                                 <figure>
                                    <img src="{{asset ('homepagetamplate/assets/images/ukk1.jpg')}}" alt="#"/>
                                    <h3>01</h3>
                                 </figure>
                              </div>
                           </div>
                     ...
                     <div class="carousel-caption">
                        <div class="row d_flex">
                           ...
                           <div class="col-md-6">
                              <div class="text_img">
                                 <figure>
                                    <img src="{{asset ('homepagetamplate/assets/images/ukk7.jpg')}}" alt="#"/>
                                    <h3>02</h3>
                                 </figure>
                              </div>
                           </div>
                     ...
                     <div class="carousel-caption">
                        <div class="row d_flex">
                           ...
                           <div class="col-md-6">
                              <div class="text_img">
                                 <figure>
                                    <img src="{{asset ('homepagetamplate/assets/images/ukk3.jpg')}}" alt="#"/>
                                    <h3>03</h3>
                                 </figure>
                              </div>
                           </div>
                     ...
                     <div class="carousel-caption">
                        <div class="row d_flex">
                           ...
                           <div class="col-md-6">
                              <div class="text_img">
                                 <figure>
                                    <img src="{{asset ('homepagetamplate/assets/images/ukk4.jpg')}}" alt="#"/>
                                    <h3>04</h3>
                                 </figure>
                              </div>
                           </div>
      ...
      <div class="team">
         <div class="container">
            <div class="row d_flex">
               <div class="col-md-5">
                  <div class="team_img">
                     <figure><img src="{{asset ('homepagetamplate/assets/images/ukk5.jpg')}}" alt="#"/></figure>
                  </div>
               </div>
         ...
         <div class="footer">
            ...
            <div class="copyright">
               <div class="container">
                  <div class="row">
                     <div class="col-md-10 offset-md-1">
                        <p>© 2023 All Rights Reserved. Design by <a href="https://www.google.com/url?sa=i&url=https%3A%2F%2Fcoolthemestores.com%2Fzero-two-wallpaper-hd-new-tab%2F&psig=AOvVaw0QstH0qb8pINqzymEdcCG5&ust=1670378675983000&source=images&cd=vfe&ved=0CA0QjRxqFwoTCLi2m9jz4_sCFQAAAAAdAAAAABAR"> Ferdy</a></p>
                     </div>
                  </div>
               </div>
            </div>
